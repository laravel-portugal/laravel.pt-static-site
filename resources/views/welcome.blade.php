...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <meta name="description" content="Laravel Portugal Framework PHP Vue VueJS Vue.js Web Application Development Programming Cloud">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 offset-md-1 py-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="https://www.facebook.com/laravelpt/" class="text-white">Like on Facebook</a></li>
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <a href="https://www.youtube.com/channel/UCIbMW1h5VReAQAwJGi_zT3w"
                           target="_blank">
                            <img class="card-img-top img-fluid" src="/img/Laravel-Portugal-Logo@512x512.jpg" alt="Laravel Live Portugal">
                            <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <a href="https://join.slack.com/t/laravel-portugal/shared_invite/enQtMzM3NTA5NjMxMDE0LTkwYjI1MGQwM2U0NzQxYzVkNmY2ZTE2ZjFjMmRhMDlkODY2MDRiNDA2NTQwOGU4ZDMwOGJlYTY4NTZjNDBiNzM"
                           target="_blank">
                            <img class="card-img-top img-fluid" src="/img/Slack-Logo-1.png" alt="Slack Laravel Portugal">
                            <div class="card-body">
                                <p class="card-text">Junta-te a nós no Slack!</p>
                            </div>
                        </a>
                    </div>
                </div>
