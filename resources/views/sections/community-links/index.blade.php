@extends('application.tailwind.master')

@section('content')

    <div class="bg-white mx-auto max-w-sm shadow-lg rounded-lg overflow-hidden mt-8">
        <div class="sm:flex sm:items-center px-6 py-4">
            <span class="block items-center mr-6">
            ...
            <div class="text-center sm:text-left sm:flex-grow">
                <div class="mb-4">
                    <p class="text-xl leading-tight">Laravel.pt</p>
                    <p class="text-sm leading-tight text-grey-dark">Comunidade Portuguesa de Laravel</p>
                </div>
            </div>
        </div>
    </div>
...
@push('before-scripts')
    <script src="{{ mix('/js/community-links/index.js') }}"></script>
@endpush