@extends('application.bootstrap.master')
        ...
        <div class="row service-areas">
            <div class="col-xs-12 col-sm-6 col-md-4 service">
                ...
                <p>
                    ...
                    <small>Também podes ouvir em formato <a href="https://laravelportugal.simplecast.fm/"
                                                            target="_blank" rel="nofollow">podcast</a>.
                    </small>
                </p>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 service">
                ...
                <p>
                    Convidamos-te a entrar no nosso canal no Slack, partilhares as tuas experiências, a expores as tuas
                    dúvidas e desafiamos-te a criar amizades <strong>na melhor comunidade portuguesa de
                        Laravel!</strong>
                </p>
            </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 service">
                <a href="{{ url('/community-links') }}" class="community-links-button">
                    <img class="service-img" src="/img/Laravel-Portugal-Logo@512x512.jpg" alt="Laravel Live Portugal">
                </a>
                ...
                <p>
                    Pesquisa os links que a comunidade adicionou como interessantes. Adiciona os teus!
                </p>
            </div>
        </div>
    </div>
